        ...
        enter(node: any) {
          ...
          if (nodeTags.contains("formatting-math-end") && mathBegin != null) {
            ...
            const latexOptions = {
              ...
              decimalSeparator:
                CalctexPlugin.INSTANCE.settings.decimalSeparator,
              digitGroupSeparator:
                CalctexPlugin.INSTANCE.settings.groupSeparator,
              fractionalDigits:
                isApproximation &&
                CalctexPlugin.INSTANCE.settings.approxDecimalPrecision !== -1
            ...
            for (const previousLine of previousLatexLines) {
              try {
                ...
                const lineExpression = calculationEngine
                  .parse(formattedPreviousLine)
                  .simplify()
            ...
            let insertIndex =
              ...
              focusedLatexLine.replace("\\\\", "").trimEnd().length
